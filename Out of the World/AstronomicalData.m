...
+ (NSArray *)allKnownPlanets
{
    ...
    //@3.7, @4879 @.... for all the numbers as seen below in the dictionary is a short hand for wrapping a primitive into an NSNumber Object type. Though primitives take up a lot less memory than objects and are much more efficient, it is important to use wrapping here because NSDictionaries only accept OBJECTS and not primitives. These will, however print out in the console the same as a primitive.
